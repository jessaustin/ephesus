...
# set up pre-signed URL? actually needs to be renewed regularly
...
aws cloudwatch put-metric-alarm --alarm-name $ALARM_NAME --alarm-description $ALARM_DESCRIPTION --actions-enabled --alarm-actions $POLICY_ARN \
